...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/archive', [ArchiveController::class, 'index'])->name('api.archives.index');
    Route::patch('/archive/{archive}/restore', [ArchiveController::class, 'restore'])->name('api.archives.restore');
});